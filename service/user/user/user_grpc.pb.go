...
func (c *userClient) Signup(ctx context.Context, in *ReqSignup, opts ...grpc.CallOption) (*RespSignup, error) {
	out := new(RespSignup)
...
func (UnimplementedUserServer) Signup(context.Context, *ReqSignup) (*RespSignup, error) {
...
func _User_Signup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).Signup(ctx, req.(*ReqSignup))
	}
